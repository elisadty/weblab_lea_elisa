...
from ..schemas.users import ChangePasswordRequest  # import du nouveau schéma
...
def change_password(
    ...
    try:
        service.change_password(user=current_user, old_password=request.old_password, new_password=request.new_password)
    except ValueError as e:
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail=str(e)
