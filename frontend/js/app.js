...
loadPage: function(page) {
    // Ajouter 'change-password' aux pages nécessitant auth
    const authRequiredPages = ['books', 'profile', 'change-password'];
    ...
    switch (page) {
        ...
        case 'profile':
            ...
            break;
        case 'change_pwd':
            this.loadChangePasswordPage();  // On ajoutera cette méthode
            break;
        default:
            this.loadLoginPage();
    }
                    ...
                    html += `
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Disponible:</strong> ${book.quantity ?? 'N/A'} exemplaire(s)</p>
                            </div>
...
loadChangePasswordPage: function() {
    ...
    document.getElementById('change-password-form').addEventListener('submit', async (e) => {
        ...
        console.log(Api);
        console.log(typeof Api.changePassword);

        try {
            await Api.changePassword(oldPassword, newPassword);
            UI.showMessage('Mot de passe modifié avec succès.');
            App.loadProfilePage(); // Revenir au profil
        } catch (error) {
